...
namespace Midterm.Data
{
    public class ApplicationDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Instructor>().HasKey(i => i.InstructorId);
            builder.Entity<Enrollment>().HasKey(e => e.EnrollmentId);
            builder.Entity<Section>().HasKey(s => s.SectionId);
            ...
            builder.Entity<Section>(entity =>
            {
                ...
                entity.Property(s => s.SectionCode).IsRequired().HasMaxLength(10);
                entity.Property(s => s.Room).IsRequired().HasMaxLength(20);
